...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <p>Hi {{ $firstName }},</p>
            <p>Thanks for registering as a Merchant. Please verify your email address
            ...
            <p class="url-wrap">{{ $verificationUrl }}</p>
            <p>If you did not create a Merchant account, you can safely ignore this email.</p>
        </div>
        <div class="footer">
